...
//#include <sys/types.h> /* alpm_off_t */
...
M.Pkg = ffi.metatype("alpm_pkg_t", {__index = {
    ...
    get_base = lib.alpm_pkg_get_base,
    ...
    get_checkdepends = lib.alpm_pkg_get_checkdepends,
    get_makedepends = lib.alpm_pkg_get_makedepends,
    ...
    set_should_ignore = lib.alpm_pkg_should_ignore,
...
M.Alpm = ffi.metatype("alpm_handle_t", {__index = {
  ...
  option_get_dbpath = lib.alpm_option_get_dbpath,
  option_get_dbext = lib.alpm_option_get_dbext,
  option_set_dbext = lib.alpm_option_set_dbext,
  option_get_logcb_ctx = lib.alpm_option_get_logcb_ctx,
  option_get_logcb = lib.alpm_option_get_logcb,
  option_set_logcb = lib.alpm_option_set_logcb,
  option_get_dlcb_ctx = lib.alpm_option_get_dlcb_ctx,
  option_get_dlcb = lib.alpm_option_get_dlcb,
  option_set_dlcb = lib.alpm_option_set_dlcb,
  option_get_fetchcb_ctx = lib.alpm_option_get_fetchcb_ctx,
  option_get_fetchcb = lib.alpm_option_get_fetchcb,
  option_set_fetchcb = lib.alpm_option_set_fetchcb,
  option_get_eventcb_ctx = lib.alpm_option_get_eventcb_ctx,
  option_get_eventcb = lib.alpm_option_get_eventcb,
  option_set_eventcb = lib.alpm_option_set_eventcb,
  option_get_questioncb_ctx = lib.alpm_option_get_questioncb_ctx,
  option_get_questioncb = lib.alpm_option_get_questioncb,
  option_set_questioncb = lib.alpm_option_set_questioncb,
  option_get_progresscb_ctx = lib.alpm_option_get_progresscb_ctx,
  option_get_progresscb = lib.alpm_option_get_progresscb,
  option_set_progresscb = lib.alpm_option_set_progresscb,
  option_get_architectures = lib.alpm_option_get_architectures,
  option_set_architectures = lib.alpm_option_set_architectures,
  option_add_architecture = lib.alpm_option_add_architecture,
  option_remove_architecture = lib.alpm_option_remove_architecture,
  option_get_assumeinstalled = lib.alpm_option_get_assumeinstalled,
  option_set_assumeinstalled = lib.alpm_option_set_assumeinstalled,
  option_add_assumeinstalled = lib.alpm_option_add_assumeinstalled,
  option_remove_assumeinstalled = lib.alpm_option_remove_assumeinstalled,
  option_get_cachedirs = lib.alpm_option_get_cachedirs,
  option_set_cachedirs = lib.alpm_option_set_cachedirs, option_add_cachedir = lib.alpm_option_add_cachedir,
  option_remove_cachedir = lib.alpm_option_remove_cachedir, option_get_hookdirs = lib.alpm_option_get_hookdirs, option_set_hookdirs = lib.alpm_option_set_hookdirs,
  option_add_hookdir = lib.alpm_option_add_hookdir,
  option_remove_hookdir = lib.alpm_option_remove_hookdir,
  option_get_logfile = lib.alpm_option_get_logfile,
  option_set_logfile = lib.alpm_option_set_logfile,
  option_get_gpgdir = lib.alpm_option_get_gpgdir,
  ...
  register_syncdb = lib.alpm_register_syncdb,
  ...
  trans_get_add = lib.alpm_trans_get_add,
  trans_get_remove = lib.alpm_trans_get_remove,
  ...
  sync_get_new_version = lib.alpm_sync_get_new_version,
...
M.pkg_find = lib.alpm_pkg_find
M.pkg_vercmp = alpm_pkg_vercmp
